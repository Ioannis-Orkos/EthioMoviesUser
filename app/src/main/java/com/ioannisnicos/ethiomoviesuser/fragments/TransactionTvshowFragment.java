...
import com.ioannisnicos.ethiomoviesuser.adapter.TransactionsTvshowRecyclerAdapter;
...
import com.ioannisnicos.ethiomoviesuser.retrofit_tvshow_response.TransactionsResponsePaging;
...
public class TransactionTvshowFragment extends Fragment {
    ...
    private TransactionsTvshowRecyclerAdapter        mTransactionsAdapter;

    private Call<com.ioannisnicos.ethiomoviesuser.retrofit_tvshow_response.TransactionsResponsePaging>         mMovieRelatedStoreMoviesCall;
    private List<TransactionTvshowResponse>           mTransactionList;
    ...
    public static TransactionTvshowFragment newInstance(String paramUserGID, String param2) {
        TransactionTvshowFragment fragment = new TransactionTvshowFragment();
    ...
    public TransactionTvshowFragment() { }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSnackbarViewID = getActivity().findViewById(R.id.drawer_layout_main);

        mTransactionList = new ArrayList<TransactionTvshowResponse>();
        intAdapter();
    ...
    public void intAdapter(){
        ...
        mTransactionsAdapter = new TransactionsTvshowRecyclerAdapter(getContext(), mTransactionList);
        ...
        mTransactionsAdapter.setOnTransactionDelButtonClickListener(new TransactionsMovieRecyclerAdapter.OnTransactionDelButtonClickListener() {
            ...
            public void onTransactionDelAcceptButtonClick(int position) {
                RequestTvshowDel(mTransactionList.get(position).getTvshow().getImdb_id(),
    ...
    private void loadMovies() {
        ...
        mMovieRelatedStoreMoviesCall = ApiClient.getRetrofitApi().getUserTransactionListTvshow(1,mMyGoogleAccountInfo.getId(),requestStatus);

        mMovieRelatedStoreMoviesCall.enqueue(new Callback<com.ioannisnicos.ethiomoviesuser.retrofit_tvshow_response.TransactionsResponsePaging>() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.all:
                requestStatus="all";
                getActivity().setTitle("All Req. Movies");
                pagesOver = false;
                presentPage = 1;
                previousTotal = 0;
                mTransactionList.clear();
            ...
            case R.id.pending:
                ...
                getActivity().setTitle("Pending Movies");
                pagesOver = false;
                presentPage = 1;
                previousTotal = 0;
                mTransactionList.clear();
...
//    }
    ...
    private void RequestTvshowDel(String movieId, String userGId, int storeId, int position){
